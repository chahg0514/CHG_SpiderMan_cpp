...
public:
	 ...
	 *
	 * In case the anchored key cannot be found in the resolveMap (or it is null) the anchor key is assumed to be a
	 * URI and the relativeKey is therefore percent encoded.
	 *
	 * Note: This function converts all backslashes to forward slashes.
	 *
	 * @param resolveMap  The ResolveMap to be used when resolving the resulting key or a nullptr if none will be used.
	 ...
	 */
	static std::wstring anchorRelativeKey(
