...
public:
	 ...
	 * @returns Pointer to the array associated with the key or 0 if key not found, the array is empty or if the value is not an array of booleans.
	 */
	 ...
	 * @returns Pointer to the array associated with the key or 0 if key not found, the array is empty or if the value is not an array of integers.
	 */
	 ...
	 * @returns Pointer to the array associated with the key or 0 if key not found, the array is empty or if the value is not an array of floats.
	 */
	 ...
	 * @returns Pointer to the array associated with the key or 0 if key not found, the array is empty or if the value is not an array of strings.
	 */
